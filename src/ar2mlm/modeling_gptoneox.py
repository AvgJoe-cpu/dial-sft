...
def convert(model_name_or_path: str, output_dir: str, random_init: bool = False):
    ...
    src_model     = transformers.AutoModelForCausalLM.from_pretrained(model_name_or_path, revision="step1000",torch_dtype=torch.bfloat16)
    src_tokenizer = transformers.AutoTokenizer.from_pretrained(model_name_or_path , revision="step1000")
