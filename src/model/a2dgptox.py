...
if __name__ == "__main__":
    ...
    config = A2DGPTNeoXConfig.from_pretrained("EleutherAI/pythia-70m")
    ...
    model = A2DGPTNeoXForCausalLM(config)
    model.save_pretrained("models-tmp/a2d-gpt-neox")
    auto_model = AutoModel.from_pretrained("models-tmp/a2d-gpt-neox")